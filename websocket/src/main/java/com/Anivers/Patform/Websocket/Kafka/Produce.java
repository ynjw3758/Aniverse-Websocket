package com.Anivers.Patform.Websocket.Kafka;
...
public class Produce {
    ...
    public Produce(KafkaTemplate<String, Object> kafkaTemplate) {
    ...
    public void ChatRead(Map<String ,Object> ReadInfo) {
        ...
        CompletableFuture.runAsync(() -> {
            try {
                logger.info("🔥 Kafka ChatRead 전송 시도 (비동기)");
                SendResult<String, Object> result = kafkaTemplate.send(topic, ReadInfo).get();
...
*/
	...
	public Map<String ,Object> SendChat(Map<String ,Object> chat_infos)  {
		String topic ="SendChat";
		Map<String ,Object> resultmsg =new HashMap<>();
		Map<String, Object> config = kafkaTemplate.getProducerFactory().getConfigurationProperties();
		try {
		    logger.info("🔥 Kafka send 시도");
		    SendResult<String, Object> result = kafkaTemplate.send(topic, chat_infos).get(); // ⬅️ 동기 처리
