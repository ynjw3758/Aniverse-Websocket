...
public class Chat_Services {
	...
	private Query_Mongo mongo;
	private final SimpMessagingTemplate messagingTemplate;
	private Produce kafka_producer;
	public Chat_Services(Query_Mongo mongo ,SimpMessagingTemplate messagingTemplate ,Produce kafka_producer) {
		this.mongo = mongo;
	...
	public void RealTimeRead(Map<String, Object> info) {
	    ...
	    payload.put("chatId", info.get("ChatId").toString());
	    payload.put("messageIds", info.get("MessageId").toString());
